...
//			$currency_code_options[ $code ] = $name . ' (' . give_get_currency_symbol( $code ) . ')';
//		}
			...
			$settings = apply_filters( 'give_general_settings', array(
				...
				array(
					'title' => __( 'Currency Options', 'give' ),
					'type'  => 'title',
					'desc'  => __( 'The following options affect how prices are displayed on the frontend.', 'give' ),
					'id'    => 'pricing_options'
				),
				...
				array(
					...
					'type'     => 'select',
					'options'  => array(
//						'left'        => __( 'Left', 'give' ) . ' (' . get_give_currency_symbol() . '99.99)',
//						'right'       => __( 'Right', 'give' ) . ' (99.99' . get_give_currency_symbol() . ')',
//						'left_space'  => __( 'Left with space', 'give' ) . ' (' . get_give_currency_symbol() . ' 99.99)',
//						'right_space' => __( 'Right with space', 'give' ) . ' (99.99 ' . get_give_currency_symbol() . ')'
					),
					'desc_tip' => true,
				),
